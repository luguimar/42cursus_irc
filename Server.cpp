...
void Server::startSocket()
{
	...
	server_adr.sin_port = htons(_server_port);
...
void Server::newClient()
{
	...
	client.setIp(inet_ntoa((client_adr.sin_addr)));
...
void Server::heartbeat()
{
    ...
    const int idleBeforePing = 60;
    const int pongTimeout    = 30;
